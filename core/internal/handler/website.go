...
func (h *WebsiteHandler) Get(c *gin.Context) {
	...
	website, err := h.websiteService.GetByID(c.Request.Context(), middleware.GetTenantID(c), id)
	if err != nil {
...
func (h *WebsiteHandler) Delete(c *gin.Context) {
	...
	if err := h.websiteService.Delete(c.Request.Context(), middleware.GetTenantID(c), id); err != nil {
		utils.InternalError(c, err.Error())
		return
	}
...
func (h *WebsiteHandler) EnableSSL(c *gin.Context) {
	...
	if err := h.websiteService.EnableSSL(c.Request.Context(), middleware.GetTenantID(c), id, req.Certificate, req.PrivateKey, req.ChainCert); err != nil {
		utils.InternalError(c, err.Error())
		return
	}
...
func (h *WebsiteHandler) ListDomains(c *gin.Context) {
	...
	domains, err := h.websiteService.ListDomains(c.Request.Context(), middleware.GetTenantID(c), websiteID)
	if err != nil {
		utils.InternalError(c, err.Error())
		return
	}
...
func (h *WebsiteHandler) DeleteDomain(c *gin.Context) {
	...
	if err := h.websiteService.DeleteDomain(c.Request.Context(), middleware.GetTenantID(c), domainID); err != nil {
		utils.InternalError(c, err.Error())
		return
	}
