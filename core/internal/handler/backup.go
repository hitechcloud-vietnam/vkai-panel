...
func (h *BackupHandler) GetJob(c *gin.Context) {
	...
	job, err := h.backupService.GetJobByID(c.Request.Context(), middleware.GetTenantID(c), id)
	if err != nil {
...
func (h *BackupHandler) DeleteJob(c *gin.Context) {
	...
	if err := h.backupService.DeleteJob(c.Request.Context(), middleware.GetTenantID(c), id); err != nil {
		utils.InternalError(c, err.Error())
		return
	}
...
func (h *BackupHandler) RunBackup(c *gin.Context) {
	...
	record, err := h.backupService.RunBackup(c.Request.Context(), middleware.GetTenantID(c), id)
	if err != nil {
		utils.InternalError(c, err.Error())
		return
	}
...
func (h *BackupHandler) DeleteRecord(c *gin.Context) {
	...
	if err := h.backupService.DeleteRecord(c.Request.Context(), middleware.GetTenantID(c), id); err != nil {
		utils.InternalError(c, err.Error())
		return
	}
