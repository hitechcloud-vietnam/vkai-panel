...
func (s *WebsiteService) Create(ctx context.Context, req *models.CreateWebsiteRequest, tenantID uuid.UUID) (*models.Website, error) {
	...
	rootDir := req.RootDir
	if rootDir == "" {
		rootDir = filepath.Join("/var/www", req.Domain)
	}
...
func (s *WebsiteService) GetByID(ctx context.Context, id uuid.UUID) (*models.Website, error) {
...
func (s *WebsiteService) Delete(ctx context.Context, id uuid.UUID) error {
	...
	return s.websiteRepo.Delete(ctx, id)
}

func (s *WebsiteService) EnableSSL(ctx context.Context, id uuid.UUID, cert, key, chain string) error {
	website, err := s.websiteRepo.GetByID(ctx, id)
	if err != nil {
		return err
	}
	...
	// Save certificates
	certDir := filepath.Join("/etc/ssl/vkai", website.Domain)
...
func (s *WebsiteService) AddDomain(ctx context.Context, websiteID uuid.UUID, domainName, domainType string) (*models.Domain, error) {
...
func (s *WebsiteService) ListDomains(ctx context.Context, websiteID uuid.UUID) ([]models.Domain, error) {
	return s.websiteRepo.ListDomains(ctx, websiteID)
}

func (s *WebsiteService) DeleteDomain(ctx context.Context, id uuid.UUID) error {
	return s.websiteRepo.DeleteDomain(ctx, id)
}
