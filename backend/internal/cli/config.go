...
func loadConfig() *viper.Viper {
	...
	v.AddConfigPath("/opt/vkai-panel")
	v.AddConfigPath(".")
...
func runConfigSet(cmd *cobra.Command, args []string) {
	...
	if configFile == "" {
		configFile = "/opt/vkai-panel/config.yaml"
	}
	...
	printInfo("Restart the API service to apply changes: systemctl restart vkai-panel-api")
}
