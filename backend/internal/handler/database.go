...
func (h *DatabaseHandler) GetServer(c *gin.Context) {
	...
	server, err := h.dbService.GetServerByID(c.Request.Context(), id)
	if err != nil {
...
func (h *DatabaseHandler) DeleteServer(c *gin.Context) {
	...
	if err := h.dbService.DeleteServer(c.Request.Context(), id); err != nil {
		utils.InternalError(c, err.Error())
		return
	}
...
func (h *DatabaseHandler) DeleteDatabase(c *gin.Context) {
	...
	if err := h.dbService.DeleteEntry(c.Request.Context(), id); err != nil {
		utils.InternalError(c, err.Error())
		return
	}
...
func (h *DatabaseHandler) ChangePassword(c *gin.Context) {
	...
	if err := h.dbService.ChangePassword(c.Request.Context(), id, req.Password); err != nil {
		utils.InternalError(c, err.Error())
		return
	}
