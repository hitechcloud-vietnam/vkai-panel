...
func (r *WebsiteRepository) GetByID(ctx context.Context, id uuid.UUID) (*models.Website, error) {
	var w models.Website
	query := `SELECT * FROM websites WHERE id = $1 AND deleted_at IS NULL`
...
func (r *WebsiteRepository) Update(ctx context.Context, w *models.Website) error {
	...
	return r.db.QueryRowContext(ctx, query,
		...
		w.PHPVersion, w.SiteType, w.Status, w.SSLEnabled,
	).Scan(&w.UpdatedAt)
}
...
func (r *WebsiteRepository) DeleteDomain(ctx context.Context, id uuid.UUID) error {
